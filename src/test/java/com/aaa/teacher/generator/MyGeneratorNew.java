package com.aaa.teacher.generator;
...
/**
 * @fileName: MyGeneratorNew
 * @description: 代码自动生成
 * @author: Mr.Chen
 * @createTime: 2020-07-15 18:56
 * @version:1.0.0
 **/
...
public class MyGeneratorNew {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("AAAStudent");
        ...
        sourceConfig.setUrl("jdbc:mysql://localhost/teacher?characterEncoding=utf8");
